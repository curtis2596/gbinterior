    ...
    <div class="card-body">
        <form method="GET" class="summary_search" action="{{ route($routePrefix . '.index') }}">
            <div class="row mb-4">
                ...
                <div class="col-md-3">
                    <x-Inputs.drop-down name="category_id" label="Category" :value="$search['category_id']" :list="$categories" class="form-control select2" />
                </div>
                <div class="col-md-3">
                    <x-Inputs.drop-down name="user_id" label="User" :value="$search['user_id']" :list="$users" class="form-control select2" />
                </div>
                <div class="col-md-3">
