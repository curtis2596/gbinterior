    ...
    <div class="row">
        <div class="offset-lg-1 col-lg-10">
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <x-Inputs.drop-down class="select2" name="from_warehouse_id" id="warehouse" label="From Warehouse" :list="$from_warehouse_list" :mandatory="true" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-3">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        <x-Inputs.text-field name="amount" label="Amount" class="form-control validate-float" />
                    </div>
                </div>
                <div class="col-md-6">
