    ...
    <div class="row">
        <div class="offset-lg-1 col-lg-10">
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-6" style="padding-top: 25px;">                            
                            ...
                            <br />
                            <x-Inputs.checkbox id="is_advance_pay" name="is_advance_pay" label="Advance Pay" value="0"  /> 
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <x-Inputs.text-area name="narration" label="Narration" :mandatory="true"  />
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function fetch_pending_amount() {
            ...
            if (to_account_id) {
                ajaxGetJson("/ledger-payments-ajax_get_pending_payable_amount/" + to_account_id, function(response) {
        ...
        $("form").submit(function() {
            ...
            var is_advance_pay = $("#is_advance_pay").prop("checked");
            if (!is_advance_pay)
            {
