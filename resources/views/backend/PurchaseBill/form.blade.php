                ...
                <tbody>
                    <tr class="sr-table-template-row hidden">
                        ...
                        <td>
                            ...
                            <input type="hidden" name="purchase_items[(sr-id)][igst]" class="igst" />
                        </td>
                        <td>
                            <x-Inputs.text-field name="purchase_items[(sr-id)][sgst_per]" label=""
                                value="0"
                            ...
                            <input type="hidden" name="purchase_items[(sr-id)][sgst]" class="sgst" />
                        </td>
                        <td>
                            <x-Inputs.text-field name="purchase_items[(sr-id)][cgst_per]" label=""
                                value="0"
                            ...
                            <input type="hidden" name="purchase_items[(sr-id)][cgst]" class="cgst" />
                        </td>
                        <td>                            
        ...
        $(document).on("change", ".item_id", function(e, opt) {
            ...
            if (v && v != "0")
            {
                ...
                ajaxGetJson("/items-ajax_get/" + v, function(response){
                    ...
                    _tr.find(".rate").val(response['data']['purchase_rate']);
