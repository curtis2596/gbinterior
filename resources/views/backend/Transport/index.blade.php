    ...
    <div class="card-body">
        <form method="GET" class="summary_search" action="{{ route($routePrefix . '.index') }}">
            <div class="row mb-4">
                ...
                <div class="col-md-3">
                    <x-Inputs.text-field name="phone_number" label="Phone No" :value="$search['phone_number']" />
                </div>
                <div class="col-md-3">
                    <x-Inputs.text-field name="gst_number" label="GST No" :value="$search['gst_number']" />
                </div>
                <div class="col-md-3">
