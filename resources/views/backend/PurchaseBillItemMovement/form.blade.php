                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-2">
                            <div class="form-group">
                                <x-Inputs.drop-down id="purchase_bill_item_id" name="purchase_bill_item_id" label="Item"
                                    :list="$itemList"
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#purchase_bill_item_id").change(function() {
            var v = $(this).val();

            $("#pending_qty").html(0);

            if (v) {
                ajaxGetJson("/purchase-bill-item-movement-ajax_get_pending_qty/" + v, function(response) {
        ...
        $("#purchase_bill_item_id").trigger("change");
