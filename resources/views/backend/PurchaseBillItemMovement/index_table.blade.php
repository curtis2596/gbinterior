        ...
        <table class="table table-striped table-bordered table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{ $record->purchaseBillItem->item->getDisplayName() }}
                        <br/>
                        SKU : {{ $record->purchaseBillItem->item->sku }}
                    </td>
                    <td>{{ $record->warehouse->getDisplayName() }}</td>
                    <td>
                        {{ $record->qty }} {{ $record->purchaseBillItem->item->unit?->getDisplayName() }}
                    </td>
                    <td>
